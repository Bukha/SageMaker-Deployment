...
Log in to the AWS console and go to the SageMaker dashboard. Click on 'Create notebook instance'. Change the region to North Virginia and apply for limit increase of ml.p2.xlarge(sagemaker) instance to 1. Also we need to apply limit increase of ml.p2.xlarge training (sagemaker training) to 1. We need to create IAM role, Lambda function, API gateway. Instructions are provided in the notebook.
